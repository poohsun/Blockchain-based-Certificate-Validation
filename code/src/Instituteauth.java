...
/**
 * Servlet implementation class Instituteauth
 */
@WebServlet("/Instituteauth")
public class Instituteauth extends HttpServlet {
	private static final long serialVersionUID = 1L;
       

    public Instituteauth() {
        super();
		...
		try
		{
			...
			while(rs.next())
			{
				...
				if(t == true)
				{
					...
					response.sendRedirect("institlogin.jsp");
				}
			}
